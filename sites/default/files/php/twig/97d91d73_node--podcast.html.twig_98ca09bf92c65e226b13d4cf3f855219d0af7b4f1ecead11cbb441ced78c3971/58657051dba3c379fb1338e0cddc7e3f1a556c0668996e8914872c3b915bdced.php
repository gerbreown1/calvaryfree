...
/* profiles/openchurch/themes/openchurch_theme/templates/node--podcast.html.twig */
class __TwigTemplate_f695f773777e55ba78f99d976d38643710c6086e08dcac1e9d997b47ffbcc8ba extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $filters = array("clean_class" => 67, "without" => 78);
        $functions = array();
...
";
    ...
    ";
            // line 87
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute((isset($context["content"]) ? $context["content"] : null), "field_date", array()), "html", null, true));
            echo "
    <div";
            // line 88
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute((isset($context["content_attributes"]) ? $context["content_attributes"] : null), "addClass", array(0 => "node__content", 1 => "clearfix"), "method"), "html", null, true));
      ...
      ";
            // line 92
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, twig_without((isset($context["content"]) ? $context["content"] : null), "comment", "links", "field_date"), "html", null, true));
            echo "
      ";
            // line 93
            if ((isset($context["audio_url"]) ? $context["audio_url"] : null)) {
                // line 94
                echo "        <a href=\"";
                echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, (isset($context["audio_url"]) ? $context["audio_url"] : null), "html", null, true));
                echo "\" class=\"button\" target=\"_blank\">play mp3 file</a>
      ";
            }
            // line 96
            echo "    </div>
...
";
    ...
    {
        return "profiles/openchurch/themes/openchurch_theme/templates/node--podcast.html.twig";
    }
    ...
    {
        return array (  117 => 96,  111 => 94,  109 => 93,  105 => 92,  98 => 90,  94 => 89,  90 => 88,  86 => 87,  81 => 86,  74 => 83,  68 => 81,  66 => 80,  61 => 78,  57 => 77,  52 => 76,  50 => 75,  48 => 71,  47 => 70,  46 => 69,  45 => 68,  44 => 67,  43 => 65,);
    }
}
/* {#*/
/* /***/
...
/*       </h2>*/
/*       {{ content|without('comment', 'links', 'field_date') }}*/
/*       {% if audio_url %}*/
/*         <a href="{{ audio_url }}" class="button" target="_blank">play mp3 file</a>*/
/*       {% endif %}*/
/*     </div>*/
/*   </article>*/
/* {% endif %}*/
